...
export const FileUploadZone: React.FC<FileUploadZoneProps> = ({
  ...
  return (
    <div className="relative w-full">
      ...
      {/* DEBUG: Temporary high visibility wrapper */}
      ...
      <div
        ...
        onDrop={handleDrop}
        onClick={handleClick}
        className={`flex items-center justify-center w-full min-h-32 sm:min-h-40 py-6 sm:py-8 border-2 border-dashed rounded-xl transition-all duration-200 ${
          dragActive
      ...
      >
        <div className="text-center px-4 w-full">
          {processing || isPickerOpen ? (
            <Loader2 className="w-8 h-8 sm:w-12 sm:h-12 text-blue-300 mx-auto mb-3 animate-spin" />
          ) : (
            <div className="relative">
              <div className="p-2 sm:p-3 bg-white/20 rounded-full mx-auto mb-3 w-fit">
