...
export const AppIconGenerator = ({ size }: AppIconGeneratorProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Main brain outline - perfectly centered */}
      <g transform="translate(50, 50)">
        ...
        {/* Central dollar sign - perfectly centered */}
