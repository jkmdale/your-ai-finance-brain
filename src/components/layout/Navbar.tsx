...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-purple-900/80 border-b border-purple-200/20">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3">
            <div className="relative h-12 w-12 group cursor-pointer">
              ...
              {/* Main logo container */}
              <div className="relative h-12 w-12 bg-gradient-to-br from-slate-900 via-purple-900/50 to-blue-900/50 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20 shadow-2xl group-hover:shadow-purple-500/25 transition-all duration-500 group-hover:scale-105">
                ...
                <div className="relative z-10 h-10 w-10 flex items-center justify-center">
                  <img 
                    ...
                    className="h-10 w-10 object-contain drop-shadow-lg group-hover:drop-shadow-2xl transition-all duration-300" 
                  />
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden backdrop-blur-xl bg-purple-900/80 border-b border-purple-200/20">
